...
reports = pd.read_csv('/teamspace/studios/this_studio/CTPA-CLIP/data/Final_Impressions.csv')
...
reports.to_csv("/teamspace/studios/this_studio/CTPA-CLIP/data/all_reports.csv")
